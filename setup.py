...
METADATA = {
    ...
    'description':      'Finish level 9 times',
...
PACKAGEDATA = {
    ...
    'package_dir': {'pywander': 'pywander',
                   },
    'packages': ['pywander',
                ],
    'scripts': ['scripts/pywander'],
}
...
_DATA_DIR = os.path.join('pywander', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'pywander': data_dirs}
...
src = []
add_files(src,os.walk('pywander'))
